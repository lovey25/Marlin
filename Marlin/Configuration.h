...
#define STRING_CONFIG_H_AUTHOR "EveryX" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HOBEOM 3D"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 400 }  // upgrade to Titan Extruder
